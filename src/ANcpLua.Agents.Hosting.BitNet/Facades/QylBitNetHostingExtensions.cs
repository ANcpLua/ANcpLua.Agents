...
///     <see cref="IChatClient" /> keyed by connection name, named <see cref="QylBitNetClientOptions" />,
...
public static class QylBitNetHostingExtensions
{
    ...
    ///         <item><c>ConnectionStrings:&lt;connectionName&gt;</c> parsed as an absolute URI into <see cref="QylBitNetClientOptions.Endpoint" />.</item>
    ...
    ///     </list>
    /// </remarks>
    public static IHostApplicationBuilder AddQylBitNetChatClient(
        this IHostApplicationBuilder builder,
        string connectionName,
        Action<QylBitNetClientOptions>? configure = null)
    {
    ...
    /// </summary>
    public static IServiceCollection AddQylBitNetChatClient(
        ...
        Action<QylBitNetClientOptions>? configure = null)
    {
        ...
        var options = new QylBitNetClientOptions();
        configure?.Invoke(options);
        options.ApplyEnvironmentOverrides();
        options.Validate();

        services.AddOptions<QylBitNetClientOptions>(connectionName)
            .Configure(target => CopyTo(options, target));
    ...
    private static QylBitNetClientOptions BuildOptions(
        IConfiguration configuration,
        string connectionName,
        Action<QylBitNetClientOptions>? configure)
    {
        var options = new QylBitNetClientOptions();
    ...
    private static void CopyTo(QylBitNetClientOptions source, QylBitNetClientOptions target)
    {
