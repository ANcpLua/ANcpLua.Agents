...
///     by <see cref="QylBitNetHostingExtensions.AddQylBitNetChatClient(Microsoft.Extensions.Hosting.IHostApplicationBuilder, string, System.Action{QylBitNetClientOptions}?)" />.
/// </summary>
/// <remarks>
///     <para>Environment-variable overrides resolved by <see cref="ApplyEnvironmentOverrides" /> take
///     precedence over bound configuration so the existing <see cref="QylBitNetClientOptions" />
///     contract used by the <c>BitNetFixture</c> (<c>BITNET_URL</c> / <c>BITNET_API_PATH</c> /
///     <c>BITNET_MODEL</c>) keeps working.</para>
/// </remarks>
public sealed class QylBitNetClientOptions
{
    ...
    /// <summary>Timeout for the <c>/health</c> probe used by <see cref="QylBitNetHealthCheck" />. Defaults to 3 seconds.</summary>
    ...
    /// </summary>
    public QylBitNetClientOptions ApplyEnvironmentOverrides()
    {
