...
///     decorator can detect already-wrapped functions and skip them. Useful when the
///     decoration (OTel spans, governance gates, …) must apply uniformly regardless of
///     where tools were registered.
/// </summary>
